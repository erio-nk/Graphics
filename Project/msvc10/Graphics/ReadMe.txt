========================================================================
    Win32 アプリケーション: Graphics プロジェクトの概要
========================================================================

この Graphics アプリケーションは、AppWizard により作成されました。
...
Graphics.ico
    ...
    ファイルです。
    このアイコンは、メイン リソース ファイル Graphics.rc 
    にインクルードされます。

small.ico
    これは、アプリケーションのアイコンの小さいバージョン (16x16) を含むアイコン 
    ファイルです。 このアイコンは、メイン リソース ファイル Graphics.rc 
    にインクルードされます。

========================================================================
    Win32 アプリケーション: Direct3D11 プロジェクトの概要
========================================================================

この Direct3D11 アプリケーションは、AppWizard により作成されました。
...
Direct3D11.ico
    ...
    ファイルです。
    このアイコンは、メイン リソース ファイル Direct3D11.rc 
    にインクルードされます。

small.ico
    これは、アプリケーションのアイコンの小さいバージョン (16x16) を含むアイコン 
    ファイルです。 このアイコンは、メイン リソース ファイル Direct3D11.rc 
    にインクルードされます。

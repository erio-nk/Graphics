========================================================================
    Win32 アプリケーション: Direct3D10 プロジェクトの概要
========================================================================

この Direct3D10 アプリケーションは、AppWizard により作成されました。
...
Direct3D10.ico
    ...
    ファイルです。
    このアイコンは、メイン リソース ファイル Direct3D10.rc 
    にインクルードされます。

small.ico
    これは、アプリケーションのアイコンの小さいバージョン (16x16) を含むアイコン 
    ファイルです。 このアイコンは、メイン リソース ファイル Direct3D10.rc 
    にインクルードされます。
